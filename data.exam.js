...
5. ผ่าน → ปลดล็อก level ถัดไป (สุ่มโจทย์ใหม่)
   ตก  → ★ จบการสอบทันที ได้คะแนนเท่าระดับที่ผ่านมาแล้ว
         ไม่มี retry ไม่มีโจทย์ใหม่ให้ลอง`, cap: "กด grademe = ตัดสินครั้งเดียว — เทสต์ในเครื่องให้แน่ก่อนเสมอ", lang: "txt" },
      { note: "**กด grademe ตอนมั่นใจเท่านั้น** — ตกข้อไหน การสอบจบตรงนั้น ไม่ได้โจทย์ใหม่มาแก้ตัว. เวลาที่เหลืออยู่ไม่มีประโยชน์ถ้ากดเร็วเกินไป" },
...
while (i >= 0) {
    ...
    implementation: [
      ...
      { note: "ติดข้อไหนนานเกิน ~25 นาที ให้ตัดสินใจ: **ยังไม่กด grademe** แล้วไล่เคสขอบต่อ หรือยอมจบที่ระดับปัจจุบัน — เพราะกดแล้วตกคือจบการสอบ ไม่มีโจทย์ใหม่ให้แก้ตัว" },
      { h: "ซ้อมก่อนสอบยังไง" },
      { ul: [
    ...
    eval: [
      { qa: [
        ...
        { q: "ติดข้อเดียวนานควรทำไง?", a: "**ห้ามกด grademe เพื่อลองเสี่ยง** — ตกคือจบการสอบทันที ไม่มี retry. ถ้ายังไม่มั่นใจให้ใช้เวลาที่เหลือไล่เคสขอบ (empty/NULL/INT_MIN/ช่องว่างซ้อน) แล้วค่อยกด; ถ้าคิดว่าทำไม่ได้จริง ก็จบที่คะแนนระดับที่ผ่านมาแล้ว" },
        { q: "กด grademe แล้วตกจะเป็นยังไง?", a: "การสอบจบทันที ได้คะแนนเท่าระดับที่ผ่านไปแล้ว — ไม่มีการสุ่มโจทย์ใหม่ให้แก้ตัว. ฉะนั้นเทสต์ในเครื่องให้ครบทุกเคสก่อนกดเสมอ" },
      ]},
      { h: "ซ้อมจริงก่อนสอบ" },
