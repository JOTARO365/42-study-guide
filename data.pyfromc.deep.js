...
"`,
      ...
      { note: "ในบริบทของ 42: `ctypes` เป็น **standard library ไม่ใช่ไลบรารีภายนอก** จึงไม่โดนข้อห้ามข้อนั้น แต่โจทย์ทุกข้อเขียนรายการ Authorized ไว้แบบ **allowlist** — อะไรไม่อยู่ในรายการคือใช้ไม่ได้ และคำว่า `ctypes` ไม่ปรากฏในโจทย์ไหนเลยสักข้อ ที่ชัดที่สุดคือ Module 06 ซึ่งอนุญาตเฉพาะโมดูลและไฟล์ที่สร้างเองในโปรเจกต์นั้น หัวข้อนี้จึงเป็นความรู้สำหรับงานหลังจบ" }
    ]
  };
